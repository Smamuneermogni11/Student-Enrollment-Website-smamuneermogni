...
The second thing we learned in software development class was Python and the importance of testing, pytest. Pytest is a Python testing framework that originated from the PyPy project. It can be used to write several types of software tests, including unit tests, integration tests, end-to-end tests, and functional tests. Its features include parametrized testing, fixtures, and assert re-writing. This is important when writing code to be certain that the code and functions you have written work. Python is a high-level, general-purpose programming language. Its design philosophy emphasizes code readability with the use of significant indentation. Python is dynamically typed, and garbage collected. It supports multiple programming paradigms, including structured, object-oriented, and functional programming. We wrote all our projects in python, which was the language used most of the time in class. We also used flask as our framework and SQL Alchemy to design our database and develop templates.

The third important thing I would say we learned is GitHub repository. Git is a distributed version control system: tracking changes in any set of files, usually used for coordinating work among programmers collaboratively developing source code during software development. Its goals include speed, data integrity, and support for distributed, non-linear workflows. We used GitHub to collaborate with other team members on the same project. We were able to track changes and keep up with what was happening with the project.  
